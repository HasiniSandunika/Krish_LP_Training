...
__decorate([
    graphql_1.Mutation(() => owner_entity_1.Owner, { name: "createOwner" }),
...
__decorate([
    graphql_1.Query(() => [owner_entity_1.Owner], { name: 'getAllOwners' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], OwnerResolver.prototype, "findAll", null);
__decorate([
    graphql_1.Query(() => owner_entity_1.Owner, { name: 'getOwnerById' }),
...
__decorate([
    graphql_1.Mutation(() => owner_entity_1.Owner, { name: 'updateOwnerById' }),
...
__decorate([
    graphql_1.Mutation(() => owner_entity_1.Owner, { name: 'removeOwnerById' }),
    __param(0, graphql_1.Args('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
